...
//		}
		...
		public static function createEngine(rootClass:Class,
				stage:Stage,antiAlias:int = 4,/*theme:Class = null,*/
...
//			if(starlingCheckerboard) starlingCheckerboard.nextFrame();
		...
		private static function initStarling():void
		{
			...
			starlingStars = new Starling(rootClass,stage, stage3DProxy.viewPort, 
				stage3DProxy.stage3D, "auto", "baseline");
			starlingStars.stage.color = 0xFFFFFF;
			starlingStars.start();
